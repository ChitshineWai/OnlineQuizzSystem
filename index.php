        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
                ...
                <div class="navbar align-self-center d-flex">
                    <a class="nav-link" href="noti.php"><i class='bx bx-bell bx-sm bx-tada-hover text-primary'></i></a>
                    <a class="nav-link" href="setting.php"><i class='bx bx-cog bx-sm text-primary'></i></a>
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                <h1
                                    ...
                                    Every  <strong>child</strong> has the right 
                                    <br> to learn.
                                </h1>
                                <p class="banner-body text-muted py-3 mx-0 px-0">
                                    These Quiz're education only. Credit to other quiz platform <a href= "https://www.w3schools.com/" target="_blank" >W3school </a> and....
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                ...
                                <a class="banner-button btn rounded-pill btn-outline-primary btn-lg px-4" href="./php/phpquiz.php?q_id=1"
...
HTML is easy to learn - You will enjoy it!
                                ...
                                <a class="banner-button btn rounded-pill btn-outline-primary btn-lg px-4" href="htmlquiz.php?q_id=1"
                                    role="button">Get Started</a>
                            </div>
                        </div>
        ...
        <div class="container-fluid pb-3">
            <div class="row">
                ...
                <div class="service-heading col-10 col-lg-9 text-start float-end light-300">
                    <h2 class="h3 pb-4 typo-space-line">PROFESSIONAL WEB TRAINING</h2>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <ul class="nav d-flex justify-content-center">
                    ...
                    <li class="nav-item mx-lg-4">
                        <a class="filter-btn nav-link btn-outline-primary shadow rounded-pill text-light px-4 light-300"
                    ...
                    <li class="filter-btn nav-item mx-lg-4">
                        <a class="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300"
                            href="#" data-filter=".mathematics">Mathematics</a>
                    </li>
                    <li class="nav-item mx-lg-4">
                        <a class="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300"
                            href="#" data-filter=".programming">Programming</a>
                    </li>
                    <li class="nav-item mx-lg-4">
                        <a class="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300"
                            href="#" data-filter=".grammer">Englishgrammer</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="container overflow-hidden py-5">
        <div class="row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3 projects">
             <!-- Start PHP Work -->           
             <div class="col-xl-3 col-md-4 col-sm-6 project programming">
                <a href="php/phpquiz.php?q_id=1" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="./assets/img/services-03.jpg" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
                            <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">PHP
                                </span>
                            <p class="card-text">PHP Test</p>
                        </div>
                    </div>
                </a>
            </div><!-- End PHP Work --> 
             <!-- Start HTML Work -->           
            <div class="col-xl-3 col-md-4 col-sm-6 project programming">
                <a href="htmlquiz.php?q_id=1" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="./assets/img/services-01.jpg" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
                            <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">HTML
                                </span>
                            <p class="card-text">HTML Test</p>
                        </div>
                    </div>
                </a>
            </div><!-- End HTML Work -->
             ...
             <div class="col-xl-3 col-md-4 col-sm-6 project programming">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    ...
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
                            <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">CSS 
                                </span>
                            <p class="card-text">CSS Test</p>
                        </div>
                    </div>
                </a>
            </div><!-- End CSS Work -->
             ...
             <div class="col-xl-3 col-md-4 col-sm-6 project programming">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    ...
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
                            <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">JavaScript 
                                </span>
                            <p class="card-text">JavaScript Test</p>
                        </div>
                    </div>
                </a>
            </div><!-- End JavaScript Work --> 

             <!-- Start Mathematics Work -->           
             <div class="col-xl-3 col-md-4 col-sm-6 project mathematics">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="./assets/img/services-05.jpg" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
                            <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">Mathematics 
                                </span>
                            <p class="card-text">Mathematics Test</p>
                        </div>
                    </div>
                </a>
            </div><!-- End mathematics Work -->  
            
             <!-- Start Grammer Work -->           
             <div class="col-xl-3 col-md-4 col-sm-6 project grammer">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="./assets/img/services-06.jpg" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
                            <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">EnglishGrammer
                                </span>
                            <p class="card-text">Grammer Test</p>
                        </div>
                    </div>
                </a>
            </div><!-- End Grammer Work -->             
        ...
        <div class="container py-5">
            <div class="row d-flex justify-content-center text-center">
                ...
                <div class="col-lg-7 col-12 text-light pt-2">
                    ...
                    <p class="light-300">This's not available.</p>
                </div>
