    ...
    <div id="work_banner" class="banner-wrapper bg-light w-100 py-5">
        <div
            ...
            <div class="banner-content col-lg-8 col-12 m-lg-auto text-center">
                <h1 class="banner-heading h2 display-3 pb-5 semi-bold-600 typo-space-line-center">HTML FUll answer</h1>
            </div>
        </div>
    </div>
    <!-- End Banner Hero -->
    <a href="index.php" class="float-end btn btn-primary stretched-link m-4">Go Home Back</a>
    <!-- Start Our Work -->
    <section class="container py-5 ">  

        <h3>Question 1:</h3>
        <p class="fs-4">What does HTML stand for?</p>
    <table class="table mb-5">
    <tr>
        <td style="background-color:#D4EDDA" class="fs-5"><i class="bi bi-check-all"></i>hyper text markup language<i class="text-danger float-end bi bi-check-all">correct answer</i></td>
    </tr>
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">hyper language text markup</td>
    </tr>
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">markup language</td>
    </tr>
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">hyper text processor</td>
    </tr>
</table>

<h3>Question 2:</h3>
        <p class="fs-4">Who is making the Web standards?</p>
    <table class="table mb-5">
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">Mozilla</td>
    </tr>
    <tr>
        <td style="background-color:#D4EDDA" class="fs-5"><i class="bi bi-check-all"></i>Google<i class="text-danger float-end bi bi-check-all">correct answer</i></td>
    </tr>
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">Microsoft</td>
    </tr>
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">The World Wide Consortium</td>
    </tr>
</table>

<h3>Question 3:</h3>
        <p class="fs-4">Choose the correct HTML element for the largest heading.</p>
    <table class="table mb-5">
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">heading tab</td>
    </tr>
    ...
    <tr>
        <td style="background-color:#D4EDDA" class="fs-5"><i class="bi bi-check-all"></i>h1 tab<i class="text-danger float-end bi bi-check-all">correct answer</i></td>
    </tr>
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">The World Wide Consortium</td>
    </tr>
...
<h3>Question 4:</h3>
        <p class="fs-4">What is the correct HTML element for inserting a line break?</p>
    <table class="table mb-5">
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">break tab</td>
    </tr>
    <tr>
        <td style="background-color:#D4EDDA" class="fs-5"><i class="bi bi-check-all"></i>br tab<i class="text-danger float-end bi bi-check-all">correct answer</i></td>
    </tr>
    <tr>
        <td style="background-color:#F1F1F1;padding-left:26px" class="fs-5">lb tab</td>
    </tr>
</table>
<a href="index.php" class="float-end btn btn-primary stretched-link m-2">Go Home Back</a>
    </section>
    <!-- End Our Work -->
        ...
        <div class="feature-work container my-4">
            <div class="row d-flex d-flex align-items-center">
                <div class="col-lg-5">
                    ...
                    <p class="feature-work-footer text-muted light-300">Consectetur adipiscing elit, sed do eiusmod
