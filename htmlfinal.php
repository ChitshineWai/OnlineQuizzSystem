    ...
    <div id="work_banner" class="banner-wrapper bg-light w-100 py-5">
        <div
            ...
            <div class="banner-content col-lg-8 col-12 m-lg-auto text-center">
                <h1 class="banner-heading h2 display-3 pb-5 semi-bold-600 typo-space-line-center">Your Score</h1>
                <h3 class="h4 pb-2 regular-400">OMG!Your HTML test score is better than other</h3>
                <p class="banner-body pb-2 light-300">
                    I'm highly of you because your score is great. <br>
                    Score is <font class="text-danger h3"><?php  
                    $sess = $_SESSION['score'];
echo $_SESSION['score'];
?> </font>.
                </p>
                <form method="post" action="htmlprocess.php">
                <button type="submit" name="f_answer" class="btn rounded-pill btn-outline-light px-4 me-4 light-300">Full answer</button>
                <button type="submit" name="home" class="btn rounded-pill btn-outline-light px-4 me-4 light-300">Go Home</button>               
                <button type="submit" name="start_a" class="btn rounded-pill btn-secondary text-light px-4 light-300">Start Again
                    Test</button>
                    </form>
    ...
    <section class="container py-5">
        <div class="row justify-content-center my-5">
            <div class="filter-btns shadow-md rounded-pill text-center col-auto">
                <a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4 active"
                    data-filter=".project" href="#">All</a>
                <a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4"
                    data-filter=".business" href="#">Business</a>
                <a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4"
                    data-filter=".marketing" href="#">Marketing</a>
                <a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4" data-filter=".social"
                    href="#">Social Media</a>
                <a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4"
                    data-filter=".graphic" href="#">Graphic</a>
            </div>
        </div>
